...
localstart:
  ...
  switch (inp) {
    ...
    case 1: {
      ...
      plotdata.open("/Users/sanaaaa/Documents/data.csv",
    ...
    case 6: {
      data.setAnalyteConcentration(
          getInput<double>("new analyte concentration: "));
      goto localstart;
    }
    case 7: {
      data.setValorantConcentration(
          getInput<double>("new valorant concentration: "));
      goto localstart;
    }
    case 8: {
      if (isnan(data.getK())) {
    ...
    case 9: {
      data.setStartingVolume(getInput<double>("new starting volume (mL): ") /
                             1000);
      goto localstart;
    }
...
localstart:
  ...
  switch (inp) {
    ...
    case 1: {
      ...
      for (double V = start; V <= end + step; V += step) {
        std::cout << "valorant (mL): " << V
                  << " | pIon: " << data.getPIon(V / 1000) << "\n";
...
Titration<WeakAcidStrongBase>::Titration()
    : data(getInput<double>("valorant concentration: "),
           getInput<double>("analyte concentration: "),
           getInput<double>("starting volume (mL): ") / 1000, askForKa()) {}
