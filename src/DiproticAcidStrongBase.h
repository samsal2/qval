...
DiproticAcidStrongBase::DiproticAcidStrongBase(const double valorantConcentration,
                                               const double analyteConcentration,
                                               const double V0,
                                               const double kA,
                                               const double kA2) :
...
k2(kA2), kB1(1e-14/k), kB2(1e-14/kA2), vE2(vE * 2)
{
    ...
    pHeq2 = 14 + log10(finalConcentrations({{1, anC * v0/(v0 + vE2)}}, {{1, 0}, {1,0}}, kB2).second[0]);
}
...
void DiproticAcidStrongBase::setAnalyteConcentration(const double analyteConcentration)
{
...
void DiproticAcidStrongBase::setValorantConcentration(const double valorantConcentration)
{
...
void DiproticAcidStrongBase::setEquilibriumConstant(const double equilibriumConstant)
{
...
void DiproticAcidStrongBase::setEquilibriumConstant2(const double equilibriumConstant)
{
