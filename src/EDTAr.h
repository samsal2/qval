...
class EDTAr {
 public:
  EDTAr(const double startingEDTAConcentration, const double metalConcentration,
        const double V0);
  /*
...
EDTAr::EDTAr(const double startingEDTAConcentration,
             const double metalConcentration, const double V0)
    : startingEDTAC(startingEDTAConcentration),
      metalC(metalConcentration),
      v0(V0) {}
